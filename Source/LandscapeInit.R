#check out the repo at https://github.com/jwillou/WILD7400_hilltopping/blob/main/source/LandscapeInit.R
#this script will intitialize the landscape by randomly selecting the location of the highest point, and then having the elevation taper off
